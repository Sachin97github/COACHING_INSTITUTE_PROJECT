...
<div class="main-home-container">
        ...
        <ul class="nav-ul">
          <li ><a  href="home.htm">Home</a></li>
            ...
            <li><a class ="active" href="facultyAdd.htm">Faculty</a></li>
            <li><a  href="studentAdd.htm">Student</a></li>
             <li><a href="staffAdd.htm">Staff</a></li>
...
<div class="container">
<h2  class="headings">Add Faculty</h2>
...
<table class="form-table" style="align:center">
		...
		<tr>
			...
			<td><frm:input cssClass="form-input"  path="subject" /></td>
		</tr>
		<tr>
